export const products = [
  {
    id: 'tesla-optimus',
    name: 'Tesla Optimus',
    tagline: 'The Future of Humanoid Automation',
    image: '/assets/tesla_optimus_1781171028026.png',
    description: 'Tesla Optimus is a general-purpose, bipedal humanoid robot capable of performing tasks that are unsafe, repetitive, or boring for humans.',
    detailedContent: [
      "The Tesla Optimus is engineered to revolutionize both industrial and domestic environments by seamlessly integrating state-of-the-art AI with advanced bipedal mechanics. Built upon the foundation of Tesla's automotive Autopilot and Full Self-Driving neural networks, Optimus navigates complex human spaces with unprecedented spatial awareness and safety.",
    ...
    specs: {
      'Height': '5 ft 8 in',
      'Weight': '160 lbs',
      'Actuators': '40 Electromechanical',
      'Vision': 'Tesla Vision Neural Net'
    },
    color: '#ffcc00'
  },
  {
    id: 'oziro-neural-vr',
    name: 'VR Headset',
    tagline: 'Immersive Reality, Perfected',
    image: '/assets/vr_headset_1781171040682.png',
    description: 'Experience unparalleled immersion with the Oziro Neural VR headset. Featuring brain-computer interface technology and dual 8K micro-OLED displays.',
    detailedContent: [
  ...
  },
  {
    id: 'unitree-go2',
    name: 'Unitree Go2',
    tagline: 'The Bionic Quadruped',
    image: '/assets/unitree_go2_1781171053761.png',
    description: 'The Unitree Go2 integrates advanced AI and dynamic locomotion, making it the perfect companion for surveillance, exploration, and entertainment.',
    detailedContent: [
      "The Unitree Go2 pushes the boundaries of robotic agility and intelligence. Equipped with an ultra-wide 4D LiDAR L1 system, the bionic quadruped perceives its environment in stunning detail, effortlessly mapping complex terrains and avoiding obstacles in real-time.",
  ...
  },
  {
    id: 'dji-neo',
    name: 'DJI Neo',
    tagline: 'Cinematic Flight in the Palm of Your Hand',
    image: 'https://images.unsplash.com/photo-1508614589041-895b88991e3e?auto=format&fit=crop&q=80',
    description: 'DJI Neo redefines portable aerial cinematography. Weighing under 250g, it features omnidirectional obstacle sensing and 4K HDR video.',
    detailedContent: [
  ...
  },
  {
    ...
    tagline: 'Visualizing the Future in Mid-Air',
    image: 'https://m.media-amazon.com/images/I/71m-ZiGZWAL._AC_SL1500_.jpg',
    description: 'Create mesmerizing mid-air 3D visuals with our ultra-high-density LED hologram fan. Perfect for advertising, events, and futuristic displays.',
    detailedContent: [
      "Step into the future of visual displays with our flagship 3D Hologram Fan. By spinning high-density LED blades at immense speeds, it utilizes the persistence of vision to project stunning, high-resolution 3D models that appear to float seamlessly in thin air.",
